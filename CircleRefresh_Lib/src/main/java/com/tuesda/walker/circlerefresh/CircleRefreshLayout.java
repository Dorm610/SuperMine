...
public class CircleRefreshLayout extends FrameLayout {
    ...
    private int mHeaderBackColor = 0x00a2e8;
    private int mHeaderForeColor = 0xffffff;
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if (mChildView != null) {
                    if (mChildView.getTranslationY() >= mHeaderHeight) {
                        ...
                        mHeader.releaseDrag();
                        mIsRefreshing = true; // 这里会把刷新开关重新置为true
                        Log.d("circle", "Now In ACTION_CANCEL and mir = "+mIsRefreshing);
